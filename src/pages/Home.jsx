  ...
  return (
    <div className='main-wrapper overflow-y-auto page-scrollbar pr-5'>
      <div className='flex flex-col'>
        ...
        <h1 className=' text-lg font-semibold text-dracula-600 dark:text-dracula-300 mt-3 cursor-default'>Podsumowanie tygodnia</h1>
        <div className='grid grid-cols-3 gap-3 my-2'>
          <SalesOverviewElement />
          <RentalOverviewElement />
          <ReservationOverviewElement />
        </div>
        <h1 className=' text-lg font-semibold text-dracula-600 dark:text-dracula-300 mt-3 cursor-default'>Zarządzaj sklepem internetowym</h1>
