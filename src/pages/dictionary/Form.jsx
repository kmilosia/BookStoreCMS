...
function Form() {
    ...
    const props = {
      ...
      putData,
      isDataLoading,
      writePermission: decodedToken?.Form?.includes('w') || decodedToken?.role === 'Admin',
      editPermission: decodedToken?.Form?.includes('e') || decodedToken?.role === 'Admin',
      deletePermission: decodedToken?.Form?.includes('d') || decodedToken?.role === 'Admin',
  };
  return (
    <>
