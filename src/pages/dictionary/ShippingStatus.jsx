...
function ShippingStatus() {
    const title = 'shipping status'
    const header = 'Shipping Statuses'
    ...
    //render array of sorted statuses from sortcategories method which returns array of sorted array
