...
function Category() {
    ...
    const props = {
      ...
      putData,
      isDataLoading,
      writePermission: decodedToken?.Category?.includes('w') || decodedToken?.role === 'Admin',
      editPermission: decodedToken?.Category?.includes('e') || decodedToken?.role === 'Admin',
      deletePermission: decodedToken?.Category?.includes('d') || decodedToken?.role === 'Admin',
  };
  return (
    <>
