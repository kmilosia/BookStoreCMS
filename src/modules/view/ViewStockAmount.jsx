  ...
  return (
    ...
    <div className='module-window'>
        ...
        <div className='module-header-row'>
                <h1 className='module-header'>{book.bookTitle}</h1>
                <CloseWindowButton handleCloseModule={handleCloseModule} />
            </div>  
            <div className='grid grid-cols-3 gap-2'>
                    <div className='flex flex-col'>
                        <p className='column-info-title'>ID Egzamplarza</p>
                        <h2 className='column-info-text'>{book.id}</h2>
                    </div>
                    <div className='flex flex-col'>
                        <p className='column-info-title'>Tytuł książki</p>
                        <h2 className='column-info-text'>{book.bookTitle}</h2>
                    </div>
                    <div className='flex flex-col'>
