...
function ManageContentElement(props) {
  ...
  return (
    (decodedToken?.[props.attribute] && Array.isArray(decodedToken[props.attribute]) && decodedToken[props.attribute].includes('r')) || (decodedToken?.[props.attribute] === 'r') || (decodedToken?.role === 'Admin')
    ) && (
